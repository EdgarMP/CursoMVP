package com.edgarmarcopolo.cursomvp.views;
...
import com.edgarmarcopolo.cursomvp.R;
import com.edgarmarcopolo.cursomvp.presenters.MainActivityPresenter;
...
public class MainActivityView extends AppCompatActivity implements MainActivity.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.textivew);
